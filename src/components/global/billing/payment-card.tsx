  ...
  return (
    ...
    >
      ...
      >
        ...
        {label === "PRO" ? (
          <span className="bg-gradient-to-r text-xl from-indigo-500 via-purple-500 font-bold to-pink-500 bg-clip-text text-transparent">
            Smart AI
          </span>
        ) : (
        ...
        {label === "PRO" ? (
          <p className="mb-2">
            <b className="text-xl">₹999</b>/month
          </p>
        ) : (
